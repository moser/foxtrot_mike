class MakeFlightsRevisable < ActiveRecord::Migration
  def self.up
        add_column :flights, :revisable_original_id, :integer
        add_column :flights, :revisable_branched_from_id, :integer
        ...
        add_column :flights, :revisable_is_current, :boolean, :default => 1
      end
