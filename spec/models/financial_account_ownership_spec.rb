...
describe FinancialAccountOwnership do
  ...
  it "should be aware of its successor if any" do
    p = Person.generate!
    o0 = FinancialAccountOwnership.create(:valid_from => 1.year.ago, :owner => p, :financial_account => FinancialAccount.generate!)
    o1 = FinancialAccountOwnership.create(:valid_from => 10.days.ago, :owner => p, :financial_account => FinancialAccount.generate!)
    o2 = FinancialAccountOwnership.create(:valid_from => 10.days.ago, :owner => p, :financial_account => FinancialAccount.generate!)
    #p = Person.find(p.id) #reload...
    o0.valid_to.should == 10.days.ago.to_date
    o1.valid_to.should == 10.days.ago.to_date
    o2.valid_to.should be_nil
  end
