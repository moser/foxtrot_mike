...
describe "/filtered_flights/index.html.haml" do
  ...
  it "renders a list of flights" do
    render
    rendered.should have_selector("span.number", :text => "0:15")
  end
  ...
  it "renders a list for each person" do
    ...
    @group_by = "people"
    render
    rendered.should have_selector("span.number", :text => "0:05")
    rendered.should have_selector("span.number", :text => "0:10")
  end
end
