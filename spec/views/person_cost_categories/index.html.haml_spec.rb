...
describe "/PersonCostCategories/index.html.haml" do
  ...
  before do
    ...
    assigns[:person_cost_categories] = @person_cost_categories = [person_cost_category_98, person_cost_category_99]
  end

  it "should render list of person_cost_categories" do
    render :template => "person_cost_categories/index.html.haml"
